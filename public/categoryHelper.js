export const inferCategory = (description) => {
	...
	return description.match(/\brents?\b|\broom\b|\broomrent\b|\bmiete\b|\balquiler\b|\bpiso\b/)
		? 3
		: null != description.match(/\bmortgage\b/)
			? 4
			: null !=
					description.match(
				...
				? 5
				: null != description.match(/\bheating\b|\bcylinder\b|\bcooking gas\b/)
					? 6
					: null !=
							description.match(
						...
						? 8
						: null != description.match(/\bparking\b|\bparken\b|\bparkimetro\b/)
							? 9
							: null != description.match(/\binsurance\b|\brenters\b|\bversicherung\b|\bseguro\b/)
								? 10
								: null != description.match(/\bnetflix\b|\butility\b|\bhulu\b|\bac\b/)
									? 11
									: null !=
											description.match(
												...
												: null !=
													...
													: null !=
														...
														: null !=
															...
															? 17
															: null != description.match(/\bpoker\b/)
																? 20
																: null !=
																		description.match(
																	...
																	? 21
																	: null != description.match(/\bmusic\b|\bconcert|\bspotify\b|\bdeezer\b/)
																		? 22
																		: null !=
																				description.match(
																			...
																			? 23
																			: null !=
																					description.match(/\bgolf\b|\bgym\b|\bbowling\b|\bpiscina\b|\bdecathlon\b/)
																				? 24
																				: null != description.match(/\bsnacks?/)
																					? 26
																					: null != description.match(/\bwashing\b|\bbooks\b|\bkeys\b|\bprime\b/)
																						? 28
																						: null !=
																								description.match(
																							...
																							? 29
																							: null != description.match(/\blaundry\b|\bcook\b|\bhaushaltsengel\b/)
																								? 30
																								: null !=
																										description.match(
																										...
																										: null !=
																											...
																											: null !=
																												...
																												: null !=
																													...
																													: null !=
																															description.match(
																																/\btrash\b|\bgarbage\b|\bm\xfcll\b|\bbasura\b/,
																															)
																														? 37
																														: null !=
																																description.match(
																																...
																																: null !=
																																	...
																																	: null !=
																																		...
																																		: null !=
																																			...
																																			: null !=
																																					description.match(
																																						/\bfedex\b|\bmassage\b|\bhigienicos?/,
																																					)
																																				? 44
																																				: null !=
																																						description.match(
																																							/\bbikes?\b|\bbicycles?\b|\bbicis?\b/,
																																						)
																																					? 46
																																					: null !=
																																							description.match(
																																							...
																																							: null != description.match(/\bgas\b/)
																																								? null !=
																																									...
																																									: (description.match(
																																										...
																																										33)
																																								: null != description.match(/\bwater\b/)
																																									? null !=
																																										description.match(
																																											/\bbottle\b|\bcan|mineral|sparkling|seltzer/,
																																										)
																																										? 12
																																										: (description.match(
